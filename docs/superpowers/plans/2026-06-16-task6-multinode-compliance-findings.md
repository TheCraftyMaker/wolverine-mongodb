...
Mongo writes do not. (Attempting to run the RavenDb test here for direct confirmation failed: its
embedded server cannot start in this environment, so this rests on source inspection.)
